    ...
    <header>
        ...
        <div class="contact-info">
            ...
            <div class="contact-item">
                ...
                <span>toysyzx@gmail.com အလုပ်အတွင်းအဆင်မပြေမှုတစ်စုံစရာရှိပါက gmail သို တင်ပြနိုင်ပါသည်။</span>
            </div>
        </div>
    </header>
...
ကြိုဆိုပါ၏။</div>
    ...
    <div id="employee-benefits" class="content-section">
        <a href="#top" class="back-to-top">← အပေါ်သို့ ပြန်သွားရန်</a> <!-- 返回顶部按钮 -->
...
<p>မူးယစ်ဆေးဝါးများကိုလက်ဝယ်ထားရှိခြင်း၊ဖြန့်ဖြူးခြင်းရောင်းချခြင်းနှင့်ကိုယ်တိုင်သံုးစွဲခြင်း မပြုရ။ တွေ့ရှိပါက အလုပ်မှနုတ်ထွက်ခံရပါမည်။</p>
...
အထက်ပါအချက်များသည် Company ၏စည်းကမ်းချက်များကိုကိုးကားထားခြင်းဖြစ်သည်။
         <div class="sub-section">
            <h3> အကောင့်လုံခြုံရေး စည်းမျဉ်းများ</h3>
            <p>
                လုပ်ငန်းခွင်မှထွက်စာတင်ပြီးနောက်ပိုင်း ( or ) နှုတ်ထွက်သွားသည့်နောက်ပိုင်းတွင်လဲ ပြင်ပမှ ကျူးလွန်ပါက ထိရောက်စွာ တရားဉပဒေအရ အရေးယူပါမည်။
မိမိကုမ္ပဏီ၏ အထူးလျှို့ဝှက်ထားရမည့် သတင်းအချက်အလက်များ၊ စာရင်းဇယားများ၊(formula)များ၊နည်းပညာရပ်ဆိုင်ရာ ထုတ်လုပ်မှုလုပ်ငန်းများစသည့် အရေးကြီးသည့်ကိစ္စများကို တစ်ခြားတစ်နေရာသို့ ပေါက်ကြားစေခြင်း၊သတင်းပေးမှုများပြုလုပ်ခြင်း၊ခွင့်ပြုချက်မရဘဲ၊တယ်လီဖုန်း၊ကင်မရာတို့ဖြင့် ဓာတ်ပုံများရိုက်ခြင်း။ အထက်ပါစည်းကမ်းချက်ကို ကျူးလွန်ကြောင်း ထင်ရှားလျှင် မည်သည့်နစ်နာကြေးအကျိုးခံစားခွင့်ကိုမျှ မခံစားရဘဲ အလုပ်မှရပ်စဲသည်အထိ အပြစ်ပေးနိုင်သည်။
            </p>
        </div>
    </div>
    ...
    <div id="business-process" class="content-section">
        <a href="#top" class="back-to-top">← အပေါ်သို့ ပြန်သွားရန်</a>
...
ဆုကြေးနှင့် ပြိုင်ပွဲအချိန် အတိအကျသည် ကုမ္ပဏီ၏ ကြေညာချက်အတိုင်းသာဖြစ်သည်
    ...
    <div class="sub-section">
            <h3>ပြိုင်ပွဲစည်းမျဥ်းများနှင့်ဆုကြေများအားကြေညာခြင်း</h3>
       <p>
         1.9.2025 ရက်နေ့တွင် Day Shift စံချိန် 600 ,Night shift စံချိန် 800ရရှိသူ 5ဉီးအား Team Leader ပြောမှ ဆုကြေး1000 ရရှိမည် ဖြစ်သည်။ မှတ်ချက်။ ။ စံချိန်ပြည့်လျှင် Team Leader မပြောထားသောသူအား ဤချက်ကို ခံစားနိုင်မည်မဟုတ်ပါ။《ဆုကြေးကို10လပိုင်းလစာတွင်ပေါင်းထည့်ပေးသွားမည်》
    ...
    <div id="safety-regulations" class="content-section">
        <a href="#top" class="back-to-top">← အပေါ်သို့ ပြန်သွားရန်</a>
        <h2>ရုံးပိတ်ရက်အစီအစဥ်များ</h2><p>
            အကြောင်းတစ်စုံတစ်ခုကြောင့် ရုံးတက်ချိန်နောက်ကျမည်ဆိုလျှင် 
ရုံးဖုန်း (or) Team Leader များဆီသို ကြိုတင်အကြောင်းကြားရမည်
          </p>	
        <div class="sub-section">
        ...
        <p>
          သင်တန်းကြောင့်ဖြစ်စေ အကြောင်းတစ်စုံတစ်ခုကြောင့်ဖြစ်စေ ပိတ်ရက် အတိအကျလိုချင်လျှင် Team Leader မှတဆင့် အထက်သိုကြိုတင်အကြောင်းကြားပြီး ပိတ်ရက်အတွက်ညှိနှိင်းနိုင်သည်
      </p>
    </div>
